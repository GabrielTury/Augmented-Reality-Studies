...
namespace AnythingWorld.Utilities 
{
    public class NetworkConfig
    {
        ...
        //User processed models following the: https://anything-world.atlassian.net/wiki/spaces/AW/pages/865927169/Web+API+documentation#user-processed-models
        public static string GetUserProcessedUri(bool namesOnly)
        {
            return $"{AW_API_STEM}/user-processed-models?key={ApiKey}&onlyName={namesOnly.ToString().ToLower()}";
        }
        //User processed models following the: https://anything-world.atlassian.net/wiki/spaces/AW/pages/865927169/Web+API+documentation#user-processed-model
        public static string GetUserProcessed(string id)
        {
            return $"{AW_API_STEM}/user-processed-model?key={ApiKey}&id={Encode(id)}";
        }
