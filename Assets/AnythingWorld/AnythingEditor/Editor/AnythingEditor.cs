...
namespace AnythingWorld.Editor
{
    public class AnythingEditor : EditorWindow
    {
        ...
        protected void DrawBehaviourField(ref MonoScript monoscript, GUIContent label, Rect position)
        {
            ...
            try
            {
                monoscript = EditorGUI.ObjectField(fieldRect, monoscript, typeof(MonoScript), true) as MonoScript;
            }
        ...
        protected bool CustomBoolField(ref bool boolean, string label, Rect position)
        {
            var labelWidth = position.width * fieldLabelWidthPercentage;
            var labelRect = new Rect(position.x + fieldPadding, position.y, labelWidth, position.height);
            var fieldWidth = position.xMax - labelRect.xMax - fieldPadding;
            ...
            boolean = GUI.Toggle(fieldRect, boolean, "");
